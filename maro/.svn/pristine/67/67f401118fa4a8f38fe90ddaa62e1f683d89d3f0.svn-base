...
import com.maro.platform.web.system.pojo.base.DynamicDataSourceEntity;
...
//				|| key.equals(DataBaseConstant.UPDATE_NAME)
	...
	public static void main(String[] args) {
		com.maro.platform.core.util.LogUtil.info(getPorjectPath());
		com.maro.platform.core.util.LogUtil.info(getSysPath());
	}
