package com.maro.platform.web.cgform.service.impl.config.util;
...
import com.maro.platform.web.cgform.service.config.DbTableServiceI;
import com.maro.platform.web.cgform.service.impl.config.DbTableMysqlHandleImpl;
import com.maro.platform.web.cgform.service.impl.config.DbTableOracleHandleImpl;
import com.maro.platform.web.cgform.service.impl.config.DbTablePostgresHandleImpl;
import com.maro.platform.web.cgform.service.impl.config.DbTableServiceMysqlImpl;
...
//		return name;
	...
	public static DbTableHandleI getTableHandle(Session  session) {
		...
		else if (dialect.equals("com.maro.platform.core.common.hibernate.dialect.MySQLServer2008Dialect")) {
			dbTableHandle = new TableSQLServerHandleImpl();
		}
