...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="maroMaterialThresholdController.do?doAdd" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="materialClassId" type="text" style="width: 150px" class="inputxt"  ignore="ignore" readonly="readonly" onclick="openMaterialselect(this)"/>
						<input type="hidden" name="materialClassId" value="" readonly="readonly"/>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="value" name="value" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
