package com.maro.manager.store.storegoods.entity;
 ...
 */
@Entity
@Table(name = "maro_store_goods", schema = "")
@SuppressWarnings("serial")
public class MaroStoreGoodsEntity implements java.io.Serializable {
	/**主键*/
