...
import com.maro.platform.web.system.pojo.base.InterroleInterfaceEntity;
import com.maro.platform.web.system.pojo.base.InterroleUserEntity;
import com.maro.platform.web.system.pojo.base.TSInterfaceDdataRuleEntity;
...
import com.maro.platform.web.system.service.InterroleServiceI;
...
public class InterroleController extends BaseController {
	...
	public void roleGrid(InterroleEntity role, HttpServletRequest request, HttpServletResponse response,
		...
		com.maro.platform.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, role);
