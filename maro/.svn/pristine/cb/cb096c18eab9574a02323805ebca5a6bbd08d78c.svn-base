...
import com.maro.platform.web.graphreport.entity.core.JformGraphreportHeadEntity;
import com.maro.platform.web.graphreport.entity.core.JformGraphreportItemEntity;
import com.maro.platform.web.graphreport.page.core.JformGraphreportHeadPage;
import com.maro.platform.web.graphreport.service.core.JformGraphreportHeadServiceI;
...
public class JformGraphreportHeadController extends BaseController {
	...
	public void datagrid(JformGraphreportHeadEntity jformGraphreportHead,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		...
		//查询条件组装器
		com.maro.platform.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, jformGraphreportHead);
		try{
		//自定义追加查询条件
		}catch (Exception e) {
