  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="maroClientReserveController.do?doAdd" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
				     	<input id="reserveTime" name="reserveTime" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" datatype="*" ignore="checked" onchange="selectShop(this)"/>
						<span class="Validform_checktip"></span>
