...
<t:formvalid formid="formobj" layout="div" dialog="true" action="msystemController.do?msaveDepart">
	...
	<fieldset class="step">
        ...
        <div class="form" style="display:none;">
            <label class="Validform_label"> 是否店铺: </label>
            <c:if test="${empty depart.orNotStore}">
            	<t:dictSelect id="orNotStore" field="orNotStore" typeGroupCode="sf_yn" hasLabel="false" type="radio" defaultVal="N"></t:dictSelect>
            </c:if>
            <c:if test="${!empty depart.orNotStore}">
            	<t:dictSelect id="orNotStore" field="orNotStore" typeGroupCode="sf_yn" hasLabel="false" type="radio" defaultVal="${depart.orNotStore}"></t:dictSelect>
            </c:if>
