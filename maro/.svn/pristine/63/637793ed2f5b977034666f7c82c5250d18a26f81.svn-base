...
<html>
 <head>
  ...
  $(document).ready(function(){
	...
	//把拼音码加上
	var dishesName = '${maroSetmealPage.dishesName}';
	query(1,dishesName);
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="maroSetmealController.do?doUpdate2" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
		     	 <input id="dishesName" name="dishesName" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${maroSetmealPage.dishesName}' onKeyUp="query(0,'')"/>
			...
			<td class="value">
		     	 <!-- <input id="coding" name="coding" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${maroSetmealPage.coding}'/> -->
				 <select name="coding" id="pinyinCode"></select>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<jsp:include page= "/webpage/com/maro/manager/common/jsp/upload.jsp">
					...
					<jsp:param name= "value" value= "${maroSetmealPage.picture}"/>
					<jsp:param name= "multiple" value= "multiple"/>
				</jsp:include> 
		     	<!-- <input id="setmealPicture" name="setmealPicture" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${maroSetmealPage.picture}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value" colspan="3">
		     	 ...
		     	 <textarea rows="" cols="" name="describes" class="inputxt" id="describes" style="height: 91px; width: 1037px;">${maroSetmealPage.describes}</textarea>
				<span class="Validform_checktip"></span>
