		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
					 ...
					 <tr>
						...
						<td class="value">
						    <input id="classificationCode" onblur="checkCoding(this,'update')" maxlength="2" datatype="/^[0-9]{2,2}$/" name="classificationCode" type="text" style="width: 150px" class="inputxt" value='${maroDishesClassificationPage.classificationCode}'/>
							<input id="classificationCode2" type="hidden"  class="inputxt"  value='${maroDishesClassificationPage.classificationCode}'/>
