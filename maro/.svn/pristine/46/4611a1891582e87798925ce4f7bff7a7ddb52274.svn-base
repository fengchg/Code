                ...
                <li>
                   <input type="hidden" class="specificationsId" name="specificationsId" value="${ds.id}">
                    <%-- <c:if test="${index.index == 0}">
                    	...
                    	<h2 class="obtain" onclick="obtf('${ds.id}')" style="height: 32px; line-height:30px;text-align: left;color: #000;font-size: 16px;font-weight: bold;text-indent: 25px;">${ds.pageName}[规格]</h2>
                        ...
                        <table style="width: 100%;" id="foodCostsTable${ds.id}" class="guigechenfen">
                            ...
                            <c:if test="${empty ds.maroSpecificationsFoodCostsList}">
                        	  <tr style="height: 42px;line-height: 42px;">
                        		...
                        		<td>
                        		  <input id="materialclassName0" type="text" datatype="*" readonly="readonly">
                        		  <input id="materialclassId0" class="materialclassId" type="hidden" datatype="*" name="foodCosts[0].materialclassId" readonly="readonly">
                        		</td>
                        		<td><input id="consumptionQuantity" readonly="readonly" datatype="/^\d+(\.\d+)?$/" name="foodCosts[0].consumptionQuantity" type="text" style="width: 100px" class="inputxt" value=""/></td>
                        	    <td><input id="unit0" readonly="readonly" readonly="readonly" type="text" style="width: 100px;" class="inputxt unit" value=""/></td>
                            ...
                            <c:forEach items="${ds.maroSpecificationsFoodCostsList}" var="dsSfc" varStatus="dsIndex">
                              <tr style="height: 42px;line-height: 42px;">
                        		...
                        		<td>
                        		  <input id="materialclassName${dsIndex.index}" readonly="readonly" type="text" datatype="*" readonly="readonly" value="${dsSfc.materialclassName}">
                        		...
                        		<td><input id="consumptionQuantity" readonly="readonly" datatype="*" name="foodCosts[${dsIndex.index}].consumptionQuantity" type="text" style="width: 100px" class="inputxt" value="${dsSfc.consumptionQuantity}"/></td>
                        	  	<td><input id="unit${dsIndex.index}" readonly="readonly" readonly="readonly" type="text" style="width: 100px;" class="inputxt unit" value="${dsSfc.materialUnitName}"/></td>
