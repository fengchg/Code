package com.maro.manager.finance.account.service.impl;
...
@Service("maroAccountService")
@Transactional
public class MaroAccountServiceImpl extends CommonServiceImpl implements MaroAccountServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(MaroAccountEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(MaroAccountEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(MaroAccountEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(MaroAccountEntity t){
		...
		map.put("identity_card", t.getIdentityCard());
		map.put("account_sex", t.getAccountSex());
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,MaroAccountEntity t){
 		...
 		sql  = sql.replace("#{identity_card}",String.valueOf(t.getIdentityCard()));
 		sql  = sql.replace("#{account_sex}",String.valueOf(t.getAccountSex()));
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("maro_account",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
