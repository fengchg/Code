  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="maroDishesController.do?doUpdate" callback="jeecgFormFileCallBack@Override">
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value" style="width: 25%;">
			   <c:if test="${userName == 'true'}">
				 <input type="radio" name="r" id="" ${maroDishesPage.sysCompanyCode =='0'?'checked':''} onclick="onRadio(0,1)" value="0">全部 &nbsp;&nbsp;&nbsp;
			     <input type="radio" name="r" id="" ${maroDishesPage.sysCompanyCode !='0'?'checked':''}  onclick="onRadio(1,1)" value="1">门店&nbsp;&nbsp;&nbsp;
			...
			<td class="value" style="width: 20%;">
			    <input id="coding" name="coding" type="text" onblur="checkCoding(this,'update','${userName}')" maxlength="4" datatype="/^[0-9]{4,4}$/" style="width: 150px" class="inputxt"   value='${maroDishesPage.coding}'/>
		...
		<tr>
			...
			<td class="value">
				<!-- <t:dictSelect field="type" type="list" datatype="*" readonly="readonly"  typeGroupCode="maro_dis_type"  defaultVal="${maroDishesPage.type}" hasLabel="false"  title="类型"></t:dictSelect> -->   
				<input id="type2" name="type2" datatype="*" readonly="true" type="text" style="width: 150px" class="inputxt" value="普通" />
				<input id="type" name="type" datatype="*" readonly="true" type="hidden" style="width: 150px" class="inputxt" value="${maroDishesPage.type}" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<input id="salesPrice" name="salesPrice" class="keyup" datatype="d" type="text" style="width: 150px" class="inputxt" keydown="keyupSalesPrice()" value='${maroDishesPage.salesPrice}'  />
				<span class="Validform_checktip"></span>
		...
		<tbody id="add_maroDishesSpecifications_table_template">
			<tr>
			 ...
			 <td align="center"><input style="width:20px;" type="checkbox" name="ck"/></td>
				  ...
				  <td align="left">
					  		<input name="maroDishesSpecificationsList[#index#].unitPrice" onkeyup="upperCase(this)" maxlength="32" type="text" class="inputxt unitPrice"  style="width:120px;"  datatype="/^(-?\d+)(\.\d+)?$/"   />
