...
//			 com.maro.platform.core.util.LogUtil.info(after_code);
//			 com.maro.platform.core.util.LogUtil.info(after_code_zimu);
//			 com.maro.platform.core.util.LogUtil.info(after_code_num);
...
//			return parentCode + getNextYouBianCode(localCode);
	...
	public static void main(String[] args) {
		// com.maro.platform.core.util.LogUtil.info(getNextZiMu('C'));
		// com.maro.platform.core.util.LogUtil.info(getNextNum(8));
		com.maro.platform.core.util.LogUtil.info(getSubYouBianCode("C99A01","B03"));
//		com.maro.platform.core.util.LogUtil.info(cutYouBianCode("C99A01B01")[2]);
	}
}
