package com.maro.manager.groupdiscount.entity;
 ...
 */
@Entity
@Table(name = "maro_group_discount", schema = "")
@SuppressWarnings("serial")
public class MaroGroupDiscountEntity implements java.io.Serializable {
	/**主键*/
	...
	/**店铺id*/
	@Excel(name="店铺id",width=15,dictTable ="maro_shop",dicCode ="id",dicText ="name")
	...
	@Column(name ="DISCOUNT_MONEY",nullable=true,length=32)
	public java.lang.Double getDiscountMoney(){
	 ...
	 */
	public void setDiscountMoney(java.lang.Double discountMoney){
