...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="maroPrinterController.do?doAdd" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
		     	 <input id="printerIp" name="printerIp" type="text" style="width: 150px" class="inputxt" datatype="*" onblur="examinePrinterIp(this,'input')" />
			...
			<td class="value">
		     	 <input id="printerPort" name="printerPort" type="text" style="width: 150px" class="inputxt" datatype="*">
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="printerName" name="printerName" type="text" style="width: 150px" class="inputxt" datatype="*" >
				<span class="Validform_checktip"></span>
