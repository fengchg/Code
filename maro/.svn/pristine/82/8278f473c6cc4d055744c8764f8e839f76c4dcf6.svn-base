...
public class PrintController extends BaseController {
	...
	public static void main(String[] args) throws IOException {
		...
		String xmlStr="<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>" +
				...
				"</section>"+
				"<nolineTable>"+
				"<cws><cw>22</cw><cw>10</cw><cw>10</cw></cws>"+
				"<ars><ar>false</ar><ar>true</ar><ar>true</ar></ars>"+
				"<rows><row><td>鸿鹤鲜锅兔小份</td><td>1</td><td>78</td></row>"+
				"<row><td>麻辣兔腿</td><td>2</td><td>20</td></row>"+
				"<row><td>豆奶</td><td>2</td><td>32</td></row>"+
				"<row><td>白米饭</td><td>2</td><td>4</td></row>"+
				"</rows></nolineTable>"+
				...
				"</section>"+
				"</doucument>";
		boolean isPrint = PrintUtil.print(xmlStr,"10.135.16.234",9100);
