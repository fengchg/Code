	...
	<c:if test="${fn:length(maroSpecificationsFoodCostsList)  <= 0 }">
			<tr>
				...
				<td align="center"><input style="width:20px;"  type="checkbox" name="ck"/></td>
				  ...
				  <td align="left">
					  	<input name="maroSpecificationsFoodCostsList[0].consumptionQuantity" maxlength="32" type="text" class="inputxt"  style="width:120px;"  datatype="d"  ignore="ignore" >
		...
		<c:forEach items="${maroSpecificationsFoodCostsList}" var="poVal" varStatus="stuts">
			<tr>
				...
				<td align="center"><input style="width:20px;"  type="checkbox" name="ck" /></td>
				   ...
				   <td align="left">
					  	<input name="maroSpecificationsFoodCostsList[${stuts.index }].consumptionQuantity" type="text" class="inputxt"  style="width:120px;"  datatype="d"  value="${poVal.consumptionQuantity }"/>
					  <label class="Validform_label" style="display: none;">消耗数量</label>
				   </td>
				   <td align="left">
