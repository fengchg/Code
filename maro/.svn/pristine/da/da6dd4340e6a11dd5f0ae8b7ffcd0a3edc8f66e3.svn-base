...
public class MaroSpecialOfferController extends BaseController {
	...
	public ModelAndView goUpdate(MaroSpecialOfferEntity maroSpecialOffer, HttpServletRequest req) {
		if (StringUtil.isNotEmpty(maroSpecialOffer.getId())) {
            ...
            String buySpecificationsCode = utilService.getRealValueBydictionary("maro_dishes_specifications,id,name", maroSpecialOffer.getBuySpecificationsId()).toString();
            String freeSpecificationsCode = utilService.getRealValueBydictionary("maro_dishes_specifications,id,name", maroSpecialOffer.getFreeSpecificationsId()).toString();
            if(buySpecificationsCode!=null||!buySpecificationsCode.equals("")){
				String buySpecificationsName = Util.getValueFromTypeByTypeCodeAndKey("maro_specifications", buySpecificationsCode);
				req.setAttribute("buySpecificationsName", buySpecificationsName);
			}
			if(freeSpecificationsCode!=null||!freeSpecificationsCode.equals("")){
				String freeSpecificationsName = Util.getValueFromTypeByTypeCodeAndKey("maro_specifications", freeSpecificationsCode);
				req.setAttribute("freeSpecificationsName", freeSpecificationsName);
			}
