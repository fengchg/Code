package com.maro.manager.shop.reserve.dto;
 ...
 *
 */
public class MaroClientReserveEntityDTO implements java.io.Serializable {
	/**主键*/
	...
	public void setReserveTime(String reserveTime) {
		...
		if(reserveTime.contains(":")){
			timeStamp = Util.date2TimeStamp(reserveTime, "yyyy-MM-dd HH:mm:ss");
		}else{
			timeStamp = Util.date2TimeStamp(reserveTime, "yyyy-MM-dd");
		}
		this.reserveTime =Long.valueOf(timeStamp);
	}
	...
	public void setPlanComeTime(String planComeTime) {
		String timeStamp=null;
		if(planComeTime.contains("-")){
			timeStamp = Util.date2TimeStamp(planComeTime, "yyyy-MM-dd HH:mm:ss");
		}else{
			timeStamp = Util.date2TimeStamp(planComeTime, "HH:mm:ss");
		}
		this.planComeTime =Long.valueOf(timeStamp);
	}
