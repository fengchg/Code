...
import com.maro.common.print.xprinter.util.ArrayUtil;
...
public class ESCPOSCode {
	...
	/** 字体大小 */
	public static final byte[] ESC_FONT_SIZE_BIG = new byte[] { GS, '!', 0x22 };
	public static final byte[] ESC_FONT_SIZE_MID = new byte[] { GS, '!', 0x11 };
	public static final byte[] ESC_FONT_SIZE_MIN = new byte[] { GS, '!', 0x00 };

	public static final byte[] ESC_LINE_SPACE = new byte[]{ESC,0x33,0x48};
	...
	public static final byte[] DLE_EOT_N (int n){return new byte[]{DLE, 0x04, (byte) n};}
