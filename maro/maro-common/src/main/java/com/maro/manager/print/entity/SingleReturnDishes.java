 ...
 *
 */
public class SingleReturnDishes  extends PrinterIp{
	...
	public String getQuitDishesTime() {
		return quitDishesTime;
	}
	public void setQuitDishesTime(String quitDishesTime) {
		this.quitDishesTime = quitDishesTime;
	}
