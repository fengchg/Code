package com.maro.manager.dishes.materialclassification.entity;
 ...
 */
@Entity
@Table(name = "maro_material_classification", schema = "")
@SuppressWarnings("serial")
public class MaroMaterialClassificationEntity implements java.io.Serializable {
	/**主键*/
	...
	@Column(name ="CLASSIFICATION_NAME",nullable=true,length=32)
	...
	@Column(name ="CLASSIFICATION_CODE",nullable=true,length=32)
	...
	@Column(name ="SHOW_ORDER",nullable=true,length=32)
