 ...
 */
@Entity
@Table(name = "maro_specifications_price", schema = "")
@SuppressWarnings("serial")
public class MaroSpecificationsPriceEntity implements java.io.Serializable {
	/**主键*/
	...
	private java.lang.String dpeartId;
	/**店铺id*/
	...
	@Column(name ="DPEART_ID",nullable=true,length=32)
	public java.lang.String getDpeartId(){
		return this.dpeartId;
	}
	 ...
	 */
	public void setDpeartId(java.lang.String dpeartId){
		this.dpeartId = dpeartId;
	}
	/**
	 *方法: 取得java.lang.String
