package com.maro.manager.store.shopstore.entity;
 ...
 */
@Entity
@Table(name = "maro_shop_store", schema = "")
@SuppressWarnings("serial")
public class MaroShopStoreEntity implements java.io.Serializable {
	/**主键*/
