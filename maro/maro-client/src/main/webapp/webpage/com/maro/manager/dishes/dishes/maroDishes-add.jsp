  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="maroDishesController.do?doAdd" callback="jeecgFormFileCallBack@Override">
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value" style="width: 25%;">
			  <c:if test="${userName == 'true'}">
				<input type="radio" name="r" id="" checked="checked" onclick="onRadio(0)">全部 &nbsp;&nbsp;&nbsp;
			    <input type="radio" name="r" id="" onclick="onRadio(1)">门店&nbsp;&nbsp;&nbsp;
			...
			<td class="value" style="width: 20%;">
				<input id="coding" name="coding" onblur="checkCoding(this,'add')" maxlength="4" datatype="/^[0-9]{4,4}$/" type="text" style="width: 150px" class="inputxt"/>
		...
		<tr>
			...
			<td class="value">
					  <t:dictSelect field="type" type="list" datatype="*"  typeGroupCode="maro_dis_type"  defaultVal="ordinary" hasLabel="false"  title="类型" ></t:dictSelect>     
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<input id="salesPrice" name="salesPrice" datatype="d" type="text" style="width: 150px" class="inputxt"   />
			</td>
