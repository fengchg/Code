...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="maroShopStoreController.do?doAdd" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
							<t:dictSelect id="shopId" datatype="*" field="shopId" type="list"  dictTable="maro_shop" dictField="id" dictText="name" dictCondition="${dictCondition}" hasLabel="false"  title="店铺"></t:dictSelect>
