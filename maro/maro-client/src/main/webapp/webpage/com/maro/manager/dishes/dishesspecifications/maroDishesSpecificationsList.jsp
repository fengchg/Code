			...
			<tr>
				...
				<td align="center"><input style="width:20px;"  type="checkbox" name="ck"/></td>
				 ...
				 <!--  <td align="left">
				  ...
				  <td align="left">
					  	<input name="maroDishesSpecificationsList[0].unitPrice" maxlength="32" type="text" class="inputxt"  style="width:120px;" datatype="/^(-?\d+)(\.\d+)?$/"  >
			...
			<tr>
				...
				<td align="center"><input style="width:20px;"  type="checkbox" name="ck" /></td>
				  ...
				  <%--  <td align="left">
				   ...
				   <td align="left">
					  	<input name="maroDishesSpecificationsList[${stuts.index }].unitPrice" maxlength="32" type="text" class="inputxt"  style="width:120px;"  datatype="/^(-?\d+)(\.\d+)?$/" value="${poVal.unitPrice }"/>
					  <label class="Validform_label" style="display: none;">单价</label>
				   </td>
				   <td align="left">
