                        ...
                        <table style="width: 100%;" id="foodCostsTable${ds.id}" class="guigechenfen">
                            ...
                            <c:forEach items="${ds.specatinsPriceShow}" var="sps" varStatus="spsIndex">
                              <tr style="height: 42px;line-height: 42px;">
                        		...
                        		<td><input id="createSource" readonly="readonly" onblur="checkTypePrice(this,${spsIndex.index},'${ds.id}',${sps.price})" datatype="d" name="specificationsPriceList[${spsIndex.index}].price" type="text" style="width: 100px" class="inputxt" value="${sps.price}"/></td>
