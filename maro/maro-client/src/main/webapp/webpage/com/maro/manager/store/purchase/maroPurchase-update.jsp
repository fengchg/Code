...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="maroPurchaseController.do?doUpdate" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
				<t:dictSelect field="shopId" type="list"  datatype="*" dictTable="maro_shop" dictField="id" dictText="name"  dictCondition="${dictCondition}" defaultVal="${maroPurchasePage.shopId}" hasLabel="false"  title="店铺"></t:dictSelect>
			...
			<td class="value">
				<input id="code" name="code" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${maroPurchasePage.code}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<input id="planStartTime" name="planStartTime" type="text" style="width: 150px"   ignore="ignore"  value='<fmt:formatDate value='${maroPurchasePage.planStartTime}' type="date" pattern="yyyy-MM-dd"/>'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
				<input id="planEndTime" name="planEndTime" type="text" style="width: 150px"   ignore="ignore"  value='<fmt:formatDate value='${maroPurchasePage.planEndTime}' type="date" pattern="yyyy-MM-dd"/>'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<t:dictSelect field="payType" type="list"  datatype="*"   typeGroupCode="maro_pay_type"  defaultVal="${maroPurchasePage.payType}" hasLabel="false"  title="支付方式" ></t:dictSelect>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
				<input id="budget" name="budget" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${maroPurchasePage.budget}'/>
				<span class="Validform_checktip"></span>
