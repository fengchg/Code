package com.maro.platform.web.cgform.service.impl.autolist;
...
import com.maro.platform.core.util.FileUtils;
		...
		try{
			...
			if(data!=null){
			    ...
			    while(it.hasNext()){
			        ...
			        //com.maro.platform.core.util.LogUtil.info("name:"+ok.toString()+";value:"+ov.toString());
			    }
