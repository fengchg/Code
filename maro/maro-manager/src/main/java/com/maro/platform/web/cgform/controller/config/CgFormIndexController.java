...
import com.maro.platform.web.cgform.entity.config.CgFormIndexEntity;
...
public class CgFormIndexController extends BaseController {
	...
	public void datagrid(CgFormIndexEntity cgFormIndex,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		...
		//查询条件组装器
		com.maro.platform.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, cgFormIndex, request.getParameterMap());
		try{
		//自定义追加查询条件
		}catch (Exception e) {
