package com.maro.platform.web.cgform.controller.fillrule;
...
public class TSFillRuleController extends BaseController {
	...
	public void datagrid(TSFillRuleEntity tSFillRule,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		...
		//查询条件组装器
		com.maro.platform.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, tSFillRule, request.getParameterMap());
		try{
		//自定义追加查询条件
		}catch (Exception e) {
