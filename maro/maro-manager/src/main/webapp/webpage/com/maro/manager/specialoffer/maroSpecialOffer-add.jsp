  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="maroSpecialOfferController.do?doAdd" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
                        <input type="text" class="inputxt"  style="width:150px;"    value="" readonly="readonly" onclick="openMaterialselect(this,'buy')"/>
				...
				<tr>
					...
					<td class="value">
						<input id="buySpecificationsName" type="text" class="inputxt"  style="width:150px;"    value="" readonly="readonly"/>
						<input id="buySpecificationsId" type="hidden" name="buySpecificationsId" style="width:120px;" value="" readonly="readonly"/>
						<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
                        <input type="text" class="inputxt"  style="width:150px;"    value="" readonly="readonly" onclick="openMaterialselect(this,'free')"/>
				...
				<tr>
					...
					<td class="value">
						<input id="freeSpecificationsName" type="text" class="inputxt"  style="width:150px;"    value="" readonly="readonly"/>
						<input id="freeSpecificationsId" type="hidden" name="freeSpecificationsId" style="width:120px;" value="" readonly="readonly"/>
						<span class="Validform_checktip"></span>
						<label class="Validform_label" style="display: none;">买的菜品规格</label>
					</td>
				</tr>
