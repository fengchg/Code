  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="maroSetmealController.do?doAdd2" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
		     	 <input id="dishesName" name="dishesName" type="text" style="width: 150px" class="inputxt" datatype="*" onKeyUp="query(0,'')" />
			...
			<td class="value">
		     	  <!-- <input id="pinyinCode" name="coding" type="text" style="width: 150px" class="inputxt"  datatype="*" /> -->
