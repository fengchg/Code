...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="maroGroupDiscountController.do?doAdd" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
							  <t:dictSelect field="shopId" type="list"  dictTable="maro_shop" dictField="id" dictText="name"  dictCondition="${dictCondition}" defaultVal="${maroGroupDiscountPage.shopId}" hasLabel="false"  title="店铺id" ></t:dictSelect>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="discountMoney" name="discountMoney" type="text" style="width: 150px" class="inputxt"  datatype="n"  ignore="checked" />
							<span class="Validform_checktip"></span>
