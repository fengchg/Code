...
<div id="main_depart_list" class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="departList" title="common.department.list" fitColumns="true" actionUrl="departController.do?departgrid" treegrid="true" idField="departid" pagination="false">
            ...
            <t:dgDelOpt url="mdepartController.do?mdel&id={id}" title="common.delete" exp="operations#eq#Y" urlclass="ace_button"  urlfont="fa-trash-o" urlStyle="background-color:#ec4758;"></t:dgDelOpt>
            <t:dgFunOpt funname="queryUsersByDepart(id)" title="view.member" urlclass="ace_button"  urlfont="fa-user"></t:dgFunOpt>
        	<t:dgFunOpt funname="theStore(id)"  title="店铺管理" urlclass="ace_button"  exp="note#eq#Y"  urlfont="fa-user" urlStyle="background-color:#09614f;"></t:dgFunOpt>
...
//        JeecgExcelExport("departController.do?exportXlsByT","departList");
    ...
    function theStore(id){
    	createwindow('店铺管理', 'maroShopController.do?goUpdateFromDepart&departId=' + id,$(document).width(),$(document).height());
    }
