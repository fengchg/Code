...
import com.maro.platform.core.util.PropertiesUtil;
...
import com.maro.platform.web.system.pojo.base.TSPasswordResetkey;
...
import com.maro.platform.web.system.sms.util.MailUtil;
...
public class LoginController extends BaseController{
	...
	public String login(ModelMap modelMap,HttpServletRequest request,HttpServletResponse response) {
		...
		if (user != null) {
			...
			session.setAttribute("maroRoleCodes", roleCodes);
