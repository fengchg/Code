package com.maro.platform.core.extend.hqlsearch;
...
import com.maro.platform.core.annotation.query.QueryTimeFormat;
import com.maro.platform.core.common.hibernate.qbc.CriteriaQuery;
import com.maro.platform.core.common.model.common.QueryCondition;
...
import com.maro.platform.core.util.JSONHelper;
...
import com.maro.platform.web.system.pojo.base.TSDataRule;
						...
						if ("class java.lang.Integer".equals(type)) {
							...
							if(!"".equals(beginValue)&&null!=beginValue)
								if(beginValue.contains("-")){
									if(beginValue.contains(":")){
										beginValue_ = DateUtil.stringToDate(beginValue, "yyyy-MM-dd hh:mm:ss").getTime();
									}else{
										beginValue_ = DateUtil.stringToDate(beginValue, "yyyy-MM-dd").getTime();
									}
								}else{
							...
							if(!"".equals(endValue)&&null!=endValue)
								if(endValue.contains("-")){
									if(endValue.contains(":")){
										endValue_ = DateUtil.stringToDate(endValue, "yyyy-MM-dd hh:mm:ss").getTime();
									}else{
										endValue_ = DateUtil.stringToDate(endValue, "yyyy-MM-dd").getTime();
									}
								}else{
