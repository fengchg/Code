...
//cb.rest.appContext = { serviceUrl: "http://42.159.96.193:9999" };
...
cb.reKeyboard = function (obj, content) {
    obj.focus(function () {
        var $$this = $$(this);
        setTimeout(function () {
            var bottom = document.body.clientHeight - ($$this.offset().top - $$("div[data-page=" + content + "] .page-content-inner").scrollTop());
            if (bottom < 44) {
                $$("div[data-page=" + content + "] .page-content-inner").css("margin-top", (bottom - 130) + "px");
            }
        }, 800);
        checkKeyBoardTimeMark = setInterval(function () {
            if (document.body.clientHeight > cb.minHeight) {
                $$("div[data-page=" + content + "] .page-content-inner").css("margin-top", "0px");;
