...
cb.web = {};
cb.webserver = {};
cb.httpsPorts = [];//端口数组，设置后，该端口将改为https协议
cb.dataFileUrl = "http://next.udh.yonyouup.com";  //数据文件服务器 （photo下的）
//cb.publicFileUrl = "https://udhrs.oss-cn-beijing.aliyuncs.com";//公共文件服务器 （public 下的）
cb.publicFileUrl = "http://next.udh.yonyouup.com";  //数据文件服务器 （photo下的）

//cb.webserver.UapServiceBaseUrl = "http://udh.yonyouup.com:90";
//cb.webserver.UapServiceBaseUrl = "http://m.udh.yonyouup.com:8521";
//cb.webserver.UapServiceBaseUrl = "http://next.udh.yonyouup.com";
cb.webserver.UapServiceBaseUrl = "http://127.0.0.1:9999";
//cb.webserver.UapServiceBaseUrl = "http://127.0.0.1:90";
